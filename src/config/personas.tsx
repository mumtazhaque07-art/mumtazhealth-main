...
export const PERSONA_CONFIG: Record<string, any> = {
  menarche: {
    ...
    wisdom: "Your body has a rhythm.",
    wisdomLong: "General maintenance and cycle health. Understanding your body's rhythm, hormones, and aligning yoga and foods to your cycle stages."
  },
  fertility: {
    id: 'fertility',
    title: 'Fertility', 
    ...
    wisdom: "Prepare the vessel with gentleness.",
    wisdomLong: 'Understanding biologically what is going on. Preparing the mind and vessel to open up, reduce stress, and welcome new life.'
  },
  pregnancy: {
    id: 'pregnancy',
    title: 'Pregnancy', 
    ...
    wisdom: "Soft strength for this trimester.",
    wisdomLong: 'Navigating the 1st, 2nd, and 3rd trimesters with gentle yoga, meditation, and safety. A time for surrender and spiritual connection.'
  },
  postpartum: {
    id: 'postpartum',
    title: 'Postpartum', 
    ...
    wisdom: "Heal at the pace of your body.",
    wisdomLong: 'Your body has gone through immense labor. Focus on breast nourishment, pelvic healing, and not rushing the process.'
  },
  perimenopause: {
    id: 'perimenopause',
    title: 'Perimenopause', 
    ...
    wisdom: "Meet the shifts with balance.",
    wisdomLong: 'Identifying doshic imbalances causing disruptions. Addressing symptoms early with targeted yoga, food, and spirituality.'
  },
  menopause: {
    id: 'menopause',
    title: 'Menopause', 
    ...
    wisdom: "Honor this powerful transition.",
    wisdomLong: 'Navigating the transition of natural or surgical menopause. Focusing on bone health, joint lubrication, and dietary shifts.'
  },
  mobility: {
    id: 'mobility',
    title: 'Wise Woman', 
    ...
    wisdom: "Stay mobile. Stay relevant.",
    wisdomLong: 'For women 70+ who want to remain relevant and empowered. Encompassing all women with chair yoga and gentle mobility.'
  }
};
