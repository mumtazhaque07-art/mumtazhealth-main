...
const PLANS: PricingPlan[] = [
  {
    ...
    features: [
      ...
      "Basic pose images & guidance",
      "Quick check-in logging",
      "Community support",
      "3 AI Wisdom Guide messages/day",
    ],
  },
  {
    id: "basic",
    ...
    features: [
      ...
      "Audio meditations & breathwork",
      "Dosha-personalised recommendations",
      "Cycle phase insights",
      "Unlimited AI Wisdom Guide",
    ],
    badge: "Popular",
    highlight: true,
    // Set these after creating Stripe products:
    // stripePriceIdMonthly: "price_xxx",
    // stripePriceIdAnnual: "price_xxx",
  },
  {
    id: "standard",
    name: "Flourish",
    monthlyPrice: 9.99,
    annualPrice: 79.99,
    description: "Full holistic experience",
    features: [
      "Everything in Bloom",
      "Full video library access",
      "Advanced Ayurvedic insights",
      "Wellness trend charts & exports",
      "Pregnancy-safe mode content",
  ...
  },
  {
    ...
    monthlyPrice: 22.99,
    annualPrice: 199.99,
    description: "Personalised guidance from Mumtaz",
    features: [
