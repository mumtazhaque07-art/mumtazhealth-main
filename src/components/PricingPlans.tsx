...
const PLANS: PricingPlan[] = [
  {
    ...
    features: [
      ...
      "Limit: 3 introductory Yoga poses",
      "Limit: 1 Ayurveda recipe & 1 meditation track",
  ...
  },
  {
    ...
    features: [
      "Unlimited Content Library Access",
      "Over 100+ holistic poses & recipes",
  ...
  },
  {
    ...
    features: [
      ...
      "1 Live Group Workshop Entry per month",
      "Direct Priority Q&A Email Support",
      "10% off Private 1-to-1 Consultations",
      "Early Access to in-person retreats",
    ],
  },
];
